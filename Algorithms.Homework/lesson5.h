...
inline void List_Dispose(List* obj);                                          // = O(1)
...
void  NodeChain_Dipose(Node* node);                     // = O(node.tailCount)  ~ O(n)
...
void  LinkedList_Dispose(LinkedList* list);                                        // = O(NodeChain_Dipose()) = O(list.count)
...
void  Stack_Dispose(Stack* obj);                   // = O(NodeChain_Dipose()) = O(obj.count)
...
void  Queue_Dispose(Queue* obj);                       // = O(NodeChain_Dipose()) = O(obj.count)
